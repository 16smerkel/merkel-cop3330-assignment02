...
public class FilterRecordsCalculator {
    public static String filterRec(String search){
        int count;
        Member temp;
        ...
        String Ans = "";
        Ans += ("Name                | Position          | Separation Date\n" +
                "--------------------|-------------------|----------------");
