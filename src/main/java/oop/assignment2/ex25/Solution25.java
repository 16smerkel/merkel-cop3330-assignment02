...
public class Solution25 {
    public static void main(String[] args) {
        ...
        int rating = passwordValidator(thePassword);
        String passRating = "";
        if(rating == 0)
        {
            passRating = ("very weak");
        }
        else if(rating == 1)
        {
            passRating = ("weak");
        ...
        {
            passRating = ("very strong");
        }
        System.out.println("The password '" + thePassword + "' is a " + passRating + " password.");
    }
